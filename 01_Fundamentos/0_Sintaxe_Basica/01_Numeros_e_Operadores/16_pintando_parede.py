"""
Exercicio 16: Pintando a Parede

    1) Objetivo: Aplicar conceitos de área e cálculo proporcional simples.
    2) Conceitos: Entrada de dados (float), multiplicação, divisão e exibição formatada.
