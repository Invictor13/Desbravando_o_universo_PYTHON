"""
Exercicio 15: Analisador de Viabilidade Financeira (Lógica Pura)

    1) Objetivo: Consolidar custos fixos, variáveis e receitas para gerar um indicador booleano de viabilidade.
    2) Conceitos: Operações aritméticas, expressões lógicas, atribuição de variáveis e saída True/False.
...
Enunciado:
    ...
    - Crie um script que receba três dados: Custo Fixo do Ônibus (float), Preço do Ingresso por Pessoa (float) 
      e a Quantidade de Passageiros Confirmados (int).O programa deve calcular:
            ...
            3. Um indicador booleano chamado 'viagem_lucrativa' que verifica se a Receita é estritamente
