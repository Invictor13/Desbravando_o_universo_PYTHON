"""
Exercicio 10: Sistema Crítico de Aprovação (Lógica Booleana Pura)

    1) Objetivo: Combinar cálculos matemáticos de médias ponderadas com operadores de comparação e lógicos.
    2) Conceitos: Média ponderada, operadores de comparação (>=), operadores lógicos (and, or) e saída booleana.
