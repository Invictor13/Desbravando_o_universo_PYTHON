"""
DESAFIO 09: Cálculo de Distância entre Dois Pontos (Fórmula Matemática)

Nível: Avançado (Sintaxe Básica)
Objetivo: Traduzir uma fórmula matemática complexa (Fórmula da Distância Euclidiana) para o Python.
Conceitos: Entrada de múltiplos dados (float), potenciação (**), precedência de operadores e raiz quadrada.
