"""
DESAFIO 06: Desestruturador de Tempo (Segundos para Horas)

Nível: Avançado (Sintaxe Básica)
Objetivo: Utilizar múltiplos operadores de divisão inteira (//) e resto (%) para converter unidades de tempo.
Conceitos: Operadores aritméticos, divisões sucessivas e formatação de saídas numéricas.
