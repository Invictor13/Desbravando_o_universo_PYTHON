"""
DESAFIO 02: Quebrador de Números (Divisão Inteira e Resto)

Nível: Avançado (Sintaxe Básica)
Objetivo: Aplicar os operadores matemáticos de divisão inteira (//) e resto (%) para isolar dígitos.
Conceitos: Operadores aritméticos avançados, precedência e conversão de tipos.
