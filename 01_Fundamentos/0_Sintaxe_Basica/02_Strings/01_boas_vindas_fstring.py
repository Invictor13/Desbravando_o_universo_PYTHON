"""
Exercicio 01: Ola Mundo Personalizado

    01) Objetivo: Desenvolver seu primeiro script focado em interatividade basica.
    02) Conceitos: Entrada (input), Saida (print) e Formatacao de Strings (f-strings).
...
Enunciado:
    ...
    - Apos receber o dado, o script deve exibir na tela uma mensagem 
      de boas-vindas personalizada no formato exato: "Ola, [Nome], bem-vindo ao Universo Python!"
