"""
Exercício 03: Manipulador de Códigos de Segurança (Fatiamento)

    1) Objetivo: Explorar a técnica de fatiamento de strings (slicing) com passos positivos e negativos.
    2) Conceitos: Indexação de strings, fatiamento [início:fim:passo], inversão de texto.
